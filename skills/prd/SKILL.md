---
name: prd
description: "Create Product Requirements Documents (PRDs) that define the end state of a feature. Use when planning a feature, starting a new project, or when asked to create a PRD. Triggers on: create a prd, write prd for, plan this feature, requirements for, spec out."
---
...
4. Generate markdown PRD to `spec/prd-<feature-name>.md` in project root
...
Save to `spec/prd-<feature-name>.md` (project root):
...
PRD saved to spec/prd-<feature-name>.md